                ...
                >
                    <YStack space="$3">
                        ...
                        <XStack space="$2" flexWrap="wrap">
                            ...
                            >
                                <XStack alignItems="center" space="$2">
                                    <Ionicons name="globe" size={isMobile ? 16 : 20} color="#667eea" />
                                    <Text fontSize={isMobile ? "$3" : "$4"} color="#667eea" fontWeight="700">
                                        Посетить Docsper.io
                                    </Text>
                                </XStack>
                            </Button>
                            ...
                            >
                                <XStack alignItems="center" space="$2">
                                    <Ionicons name="search" size={isMobile ? 16 : 20} color="#fff" />
                                    <Text fontSize={isMobile ? "$3" : "$4"} color="#fff" fontWeight="600">
                                        Поиск лекарств
                                    </Text>
                                </XStack>
                            </Button>
